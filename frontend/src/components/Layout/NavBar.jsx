        ...
        <div className="relative z-20 flex items-center gap-1.5 font-semibold text-white sm:gap-2 md:gap-4">
          ...
          >
            ...
            >
              ...
              <span
                className={`flex h-4 w-4 items-center justify-center text-[9px] text-gray-500 transition-all duration-300 ${
                  isOpen
            ...
            >
              ...
              >
                ...
                <span className="text-gray-700 transition-all duration-200 group-hover:translate-x-1 group-hover:text-[#FF1AC6]">
                  →
                </span>
              </Link>
